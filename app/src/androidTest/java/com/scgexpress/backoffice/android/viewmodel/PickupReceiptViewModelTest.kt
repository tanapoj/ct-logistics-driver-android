...
import com.scgexpress.backoffice.android.model.pickup.SubmitReceiptErrorField
import com.scgexpress.backoffice.android.model.pickup.SubmitReceiptResponse
...
class PickupReceiptViewModelTest {
    ...
    fun setUp() {
        ...
        this.viewModel = PickupReceiptViewModel(
            appContext,
            rxThreadScheduler,
            pickupRepo,
            dataRepo,
    ...
    fun send_receipt() {
        ...
        val taskId = "1"
        val customerCode = "99998"
        val personalId = "001"
        val userId = "0246"
        val payment = 0
        val tel = "08412345678"
        val email = "suprinya.pa@centrilliontech.co.th"
        val data = listOf(
            PickupScanningTrackingEntity(taskId = "1", deliveryFee = 150.0),
            PickupScanningTrackingEntity(taskId = "1", deliveryFee = 655.0),
            PickupScanningTrackingEntity(taskId = "1", deliveryFee = 960.0),
            PickupScanningTrackingEntity(taskId = "1", deliveryFee = 55.0)
        )


        val response = listOf(
            SubmitReceiptResponse(
                "TASK_SUMMARY_SUBMITED", "1", SubmitReceiptErrorField("", ""), ""
            )
        )
