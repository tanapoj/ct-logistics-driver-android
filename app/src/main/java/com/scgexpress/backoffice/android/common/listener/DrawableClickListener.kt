package com.scgexpress.backoffice.android.common.listener
...
abstract class DrawableClickListener @JvmOverloads constructor(
        view: TextView, drawableIndex: Int,
        private val fuzz: Int = DrawableClickListener.DEFAULT_FUZZ
) : OnTouchListener {
    /**
    ...
    abstract class LeftDrawableClickListener : DrawableClickListener {
         ...
         */
        constructor(view: TextView) : super(view, DrawableClickListener.DRAWABLE_INDEX_LEFT) {}
         ...
         */
        constructor(view: TextView, fuzz: Int) : super(view, DrawableClickListener.DRAWABLE_INDEX_LEFT, fuzz) {}
    ...
    abstract class TopDrawableClickListener : DrawableClickListener {
         ...
         */
        constructor(view: TextView) : super(view, DrawableClickListener.DRAWABLE_INDEX_TOP) {}
         ...
         * included to account for the size of a finger.
         */
        constructor(view: TextView, fuzz: Int) : super(view, DrawableClickListener.DRAWABLE_INDEX_TOP, fuzz) {}
    ...
    abstract class BottomDrawableClickListener : DrawableClickListener {
         ...
         */
        constructor(view: TextView) : super(view, DrawableClickListener.DRAWABLE_INDEX_BOTTOM) {}
         ...
         * included to account for the size of a finger.
         */
        constructor(view: TextView, fuzz: Int) : super(view, DrawableClickListener.DRAWABLE_INDEX_BOTTOM, fuzz) {}
