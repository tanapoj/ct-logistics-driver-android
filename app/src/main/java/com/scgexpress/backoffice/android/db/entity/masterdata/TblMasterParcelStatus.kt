...
@Entity(tableName = "tbl_master_parcel_status")
data class TblMasterParcelStatus(
    ...
    @Json(name = "name_short") @SerializedName("name_short") @ColumnInfo(name = "name_short") var nameShort: String? = "",
    @Json(name = "name_long") @SerializedName("name_long") @ColumnInfo(name = "name_long") var nameLong: String? = "",
