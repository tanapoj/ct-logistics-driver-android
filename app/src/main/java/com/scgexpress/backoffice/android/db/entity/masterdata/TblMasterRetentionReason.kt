...
@Entity(tableName = "tbl_master_retention_reason")
data class TblMasterRetentionReason(
    ...
    @Json(name = "code_neko") @SerializedName("code_neko") @ColumnInfo(name = "code_neko") var codeNeko: String? = "",
