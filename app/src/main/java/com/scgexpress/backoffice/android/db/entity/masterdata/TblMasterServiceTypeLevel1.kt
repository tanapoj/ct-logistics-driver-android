...
@Entity(tableName = "tbl_master_service_type_level_1")
data class TblMasterServiceTypeLevel1(
    ...
    @Json(name = "code_service_type_level_1") @SerializedName("code_service_type_level_1") @ColumnInfo(name = "code_service_type_level_1") var codeServiceTypeLevel1: String? = "",
