...
@Entity(tableName = "tbl_master_service_type_level_2")
data class TblMasterServiceTypeLevel2(
    ...
    @Json(name = "code_service_type_level_2") @SerializedName("code_service_type_level_2") @ColumnInfo(name = "code_service_type_level_2") var codeServiceTypeLevel2: String? = "",
