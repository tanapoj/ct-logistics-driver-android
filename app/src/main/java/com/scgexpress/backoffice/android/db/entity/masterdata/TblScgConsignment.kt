...
@Entity(tableName = "tbl_scg_consignment")
data class TblScgConsignment(
    ...
    @Json(name = "date_created_index") @SerializedName("date_created_index") @ColumnInfo(name = "date_created_index") var dateCreatedIndex: String? = "",
    @Json(name = "date_modified_index") @SerializedName("date_modified_index") @ColumnInfo(name = "date_modified_index") var dateModifiedIndex: String? = "",
