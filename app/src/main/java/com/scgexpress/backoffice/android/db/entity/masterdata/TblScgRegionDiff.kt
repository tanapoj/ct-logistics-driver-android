...
@Entity(tableName = "tbl_scg_region_diff")
data class TblScgRegionDiff(
    ...
    @Json(name = "id_origin_region") @SerializedName("id_origin_region") @ColumnInfo(name = "id_origin_region") var idOriginRegion: Int = 0,
    @Json(name = "id_destination_region") @SerializedName("id_destination_region") @ColumnInfo(name = "id_destination_region") var idDestinationRegion: Int = 0,
