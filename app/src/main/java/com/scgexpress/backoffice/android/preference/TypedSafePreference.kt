...
open class TypedSafePreference internal constructor(private val mSharedPreferences: SharedPreferences) : SharedPreferences {
    ...
    private fun handleInvalidType(key: String, e: ClassCastException) {
        if (com.scgexpress.backoffice.android.BuildConfig.DEBUG) {
            ...
            //AnalyticsHelper.INSTANCE.sendException(e, false);
        }
    }
    ...
    companion object {
        ...
        fun from(sharedPreferences: SharedPreferences): TypedSafePreference {
            return TypedSafePreference(sharedPreferences)
        }
    }
}