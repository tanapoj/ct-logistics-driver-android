...
import kotlinx.android.synthetic.main.activity_ofd_cant_sent.*

class OfdCantSentActivity : BaseActivity() {

    private val mFragment by lazy {
        OfdCantSentFragment.newInstance(viewModel, trackingID!!)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ofd_cant_sent)

        viewModel = ViewModelProviders.of(this, viewModelFactory).get(OfdCantSentViewModel::class.java)
