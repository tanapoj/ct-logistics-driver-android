...
class OfdRetentionActivity : BaseActivity() {

    private val mFragment by lazy {
        OfdRetentionFragment.newInstance(viewModel, trackingID!!)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(OfdRetentionViewModel::class.java)
        getIntentManifestID()
