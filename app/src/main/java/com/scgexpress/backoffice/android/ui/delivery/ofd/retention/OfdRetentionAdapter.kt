...
class OfdRetentionAdapter(private val viewModel: OfdRetentionViewModel) :
    RecyclerView.Adapter<OfdRetentionAdapter.BaseViewHolder>() {
    companion object {
    ...
    class ItemViewHolder(view: View) : BaseViewHolder(view) {
        ...
        fun bind(item: DeliveryTask, viewModel: OfdRetentionViewModel) = with(itemView) {
