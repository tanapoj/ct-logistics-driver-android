...
class PhotoSelectDialogAdapter(
    context: Context,
    private val mListener: PhotoSelectDialogFragment.OnOptionSelectedListener,
    val viewModel: PhotoDialogViewModel
) :
    RecyclerView.Adapter<PhotoSelectDialogAdapter.ReStatusDialogViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ReStatusDialogViewHolder, position: Int) {
        ...
        viewModel.loadPhoto(item.photoStored, holder.image)
