...
class PickupDetailsActivity : BaseActivity(), RejectStatusDialogFragment.OnStatusSelectedListener,
    PhotoSelectDialogFragment.OnOptionSelectedListener {

    private val viewModel by lazy {
        ViewModelProviders.of(this, viewModelFactory).get(PickupDetailsViewModel::class.java)
    }
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            supportFragmentManager.beginTransaction()
                .replace(R.id.clContainer, PickupDetailsFragment.newInstance(viewModel))
                .commit()
        }
    }
